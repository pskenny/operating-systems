...
// Both threads locks a resource and waits for the other to release. Both at a 
// deadlock as no resource is released for the other as they wait for each other
// 
// |------o
// v      ^
// o------|
